...
export default function Resumo() {
  return (
    <section className=" flex flex-col lg:flex-row h-screen">
      <div className="w-12/12 lg:w-5/12 h-1/2 lg:h-screen flex px-5 bg-slate-200">
        <div className="m-auto w-7/12 text-black">
          <div className="mb-5">
            <span className="font-regular font-raleway text-2xl md:text-4xl text-blue-950">
              Olá, eu sou
            </span>{" "}
          </div>
          <strong><h3 className="font-extrabold font-raleway text-4xl md:text-6xl 2xl:text-8xl text-blue-950">
            Ícaro Teodoro.
          </h3></strong>
          <div className="mt-5">
            <span className="font-regular font-raleway text-2xl md:text-4xl  text-blue-950">
      ...
      <div className="w-12/12 lg:w-7/12 h-1/2 lg:h-screen bg-slate-500 flex flex-col px-5 md:px-40 py-8">
